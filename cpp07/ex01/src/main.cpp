...
/*   Updated: 2023/12/01 15:07:32 by nimai            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main( void )
{
	...
	{		
		...
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> Empty arrays" << RESET << std::endl;
		int		intArray[ ] = {};
		char	charArray[] = {};
		double	doubleArray[] = {};
		float	floatArray[] = {};
		...
		std::cout << std::endl;
		std::cout << "\tEmpty char array: ";
		::print<char>(charArray, len);
		std::cout << std::endl;
		std::cout << "\tEmpty double array: ";
	...
	{		
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> Int array test" << RESET << std::endl;
	...
	{		
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> Float array test" << RESET << std::endl;
	...
	{		
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> Double array test" << RESET << std::endl;
	...
	{		
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> Char array test" << RESET << std::endl;
	...
	{		
		std::cout << CYAN << std::setfill('=') << std::setw(25) << ">>> String array test" << RESET << std::endl;
